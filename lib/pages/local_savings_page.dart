              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Image.asset(
                        // Assumes lowercase with underscores (e.g., "Giant Tiger" -> "giant_tiger.png")
                        'assets/images/stores/${deal.store.toLowerCase().replaceAll(' ', '_')}.png',
                        height: 28,
                        width: 48,
                        fit: BoxFit.contain,
                        alignment: Alignment.centerLeft, // Ensures square logos don't float in the middle of the 48px width
                        errorBuilder: (context, error, stackTrace) {
                          return SizedBox(
      width: 48, // Match the image width
      child: Align(
