...
class _LocalSavingsPageState extends State<LocalSavingsPage> {
  ...
  List<_SampleDeal> get _filteredDeals {
  ...
  List<_SampleDeal> get _featuredDeals {
    final eligibleDeals =
        _deals.where((deal) => deal.regularPrice > deal.salePrice).toList();
  ...
  Widget build(BuildContext context) {
    ...
    final featuredDeals = _featuredDeals;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Text(
            'Compare active deals from local stores. '
            'Always confirm price and availability before visiting.',
            style: TextStyle(
          ...
          if (featuredDeals.isEmpty)
            const _EmptyDealsCard(
              message: 'No price reductions are available to compare yet.',
            )
          else
            ...featuredDeals.map(
          ...
          _SectionTitle(
            ...
            subtitle: '${filteredDeals.length} deal'
          ...
          if (filteredDeals.isEmpty)
            const _EmptyDealsCard(
              message: 'No deals match this search or category.',
            )
          else
            ...filteredDeals.map(
          ...
          Text(
            ...
            'change. Verify the offer directly with the store before visiting.',
            style: TextStyle(
              fontSize: 12,
              height: 1.4,
